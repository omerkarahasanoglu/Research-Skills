...
class EnhancedBanditEnvironment:
    def __init__(self, n_arms, seed=None, env_type="increasing_arms"):
        """
...
def run_simulation(n_arms=5, n_steps=10000, seed=42, env_type="increasing_arms", include_parameter_variants=True):
...
def main(n_arms=5, n_steps=10000, seed=42, analysis_window=100, env_type="increasing_arms"):
    """
...
def parameter_sensitivity_analysis(n_arms=5, n_steps=5000, seed=42, env_type="increasing_arms"):
    """
...
if __name__ == "__main__":
    ...
    CONFIG = {
        "env_type": "increasing_arms",  # Set to "increasing_arms" or "irregular_change"
        "n_arms": 20,                    # Initial number of arms
